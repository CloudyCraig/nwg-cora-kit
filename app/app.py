...
AGENT_ID = os.environ.get("CORA_AGENT_ID", "cora-natwest-assistant")
BANK_NAME = os.environ.get("CORA_BANK_NAME", "NatWest")
...
SYSTEM_GROUNDED = (
    f"You are {AGENT_NAME}, {BANK_NAME}'s friendly AI banking assistant in the mobile/online "
    ...
    f"step. Never invent {BANK_NAME} policies, fees, or specifics about the customer's account."
)
